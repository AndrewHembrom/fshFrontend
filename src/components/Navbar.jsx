...
const Navbar = () => {
  ...
  return (
    <div className="mx-auto flex flex-row justify-around bg-slate-800 p-4 rounded-full shadow-lg w-2/3">
      <Link
        to={"/"}
        className="text-white px-6 py-2 rounded-full transition-all duration-300 hover:text-white hover:bg-slate-200 hover:shadow-md hover:border hover:border-blue-600 hover:text-black"
      >
        Home
      </Link>
      <Link
